# Классические статистические методы машинного обучения

1. [Регрессия](#регрессия)  
2. [Классификация](#классификация)  
3. [Кластеризация](#кластеризация)  
4. [Деревья принятия решений](#деревья-принятия-решений)  
5. [Методы понижения размерности](#методы-понижения-размерности)  
6. Ансамбли, бустинг, бэггинг
...
Пример применения: поиск наиболее похожего изображения. Картинку превратили в embedding. У нас есть своя собственная база с embedding-ами и теперь нам необходимо найти наиболее похожее изображение. Для этого можно использовать HNSW. Он сможет найти изображения, расстояния между которыми в сравнении с искомым меньше заданного порогового значения за логарифмическое время.
[Ссылка с описанием](https://habr.com/ru/company/mailru/blog/338360/)
