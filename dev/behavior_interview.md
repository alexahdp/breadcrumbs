...
## Score
 * Situation - описание контекста  
 * Complication - в чем заключалась сложность?  
 * Outcome expectation - что могло случиться если ничего не предпринять?
 * Remedial action - что вы сделали для решения проблемы?
 * End result - как в итоге разрешилась ситуация, чем все закончилось?
